window.BMAP_AUTHENTIC_KEY = "aNlDZSHMjCFWuIyUd23Z6F8sVzo5QPwH";
(function() {
	function aa(a) {
		throw a;
	}
	...
	x.extend(La.prototype, {
		...
		hk: function(a, b, c, d) {
			...
			if (c = c && d ? f.Im(c, this.Wb) : this.mc)
				if (this.mc = new H(c.lng + a * e, c.lat - b * e), (a = f.ph(this.mc, this.Wb)) && g) this.gf = a
		},
		Eg: function(a, b) {
		...
		YL: function(a) {
			a ? this.ks && this.ks.Af === a || (this.yh(this.ks), this.ks = new mb({
				geotableId: a
			}), this.Xg(this.ks)) : this.yh(this.ks)
		},
		Vb: function() {
		...
		function(a, b, c) {
			...
			if (!C || !C.Fo) {
				var B = b.all && a.attachEvent,
					D = C && C.wE || +new Date,
					A = a.o3 || (+new Date).toString(36) + Math.random().toString(36).substr(2, 3),
					G = 0,
					J = {},
					L = function(a) {
						var b = arguments,
	...
	var dc = E.qa + "menu_zoom_in.png",
		ec = E.qa + "menu_zoom_out.png";
	...
	function yc(a, b) {
		var c = this;
		xc() && (a === j && aa(Error("\u6ca1\u6709\u4f20\u5165points\u6570\u636e")), "[object Array]" !== Object.prototype.toString.call(a) && aa(Error("points\u6570\u636e\u4e0d\u662f\u6570\u7ec4")), b = b || {}, fb.apply(c, arguments), c.ea = {
			ia: a
		}, c.z = {
			shape: b.shape || vc,
			size: b.size || wc,
	...
	x.extend(Fc.prototype, {
		...
		wm: function(a, b, c) {
			...
			for (d = this.Qc.length; l < d; l++) {
				...
				for (m = this.Me.length; w < m; w++)
					if (n = this.Me[w], n.id == k + "_" + b + "_" + B + "_" + i + "_" + f) {
						n.er = o;
						this.Pm[n.id] = n;
						break
					}
		...
		mI: function(a) {
			...
			for (var g = 0; g < c; g++) {
				...
				if (!i.$H && !(i.mp && !this.map.Vb() || i.jM && this.map.Vb())) {
					...
					w = [];
					for (d.KB = []; n < v; n++)
						for (y = l; y < e; y++) w.push([n, y]), d.KB.push({
							x: n,
							y: y
						});
		...
		Xg: function(a) {
			...
			else if (c.Yf && this.map.Xg(c.Yf), c.mp) {
		...
		yh: function(a) {
			...
			if (a instanceof cb) b && a.Em && (a.remove(), a.Em = q);
				...
				if (a.mp)
					for (var b = 0, c = this.Dg.length; b < c; b++) a == this.Dg[b] && this.Dg.splice(b, 1);
				else {
					b = 0;
		...
		Qt: function(a) {
			...
			if (!this.map.Vb() && (a ? this.map.K.s_ = a : a = this.map.K.s_, a))
				for (var c = p, c = "2" == z.Oy ? [z.url.proto + z.url.domain.main_domain_cdn.other[0] + "/"] : [z.url.proto + z.url.domain.main_domain_cdn.baidu[0] + "/", z.url.proto + z.url.domain.main_domain_cdn.baidu[1] + "/", z.url.proto + z.url.domain.main_domain_cdn.baidu[2] + "/"], d = 0, e; e = this.Jm[d]; d++)
					if (e.f_ == o) {
						b.k.$b = 18;
	...
	x.extend(Oa.prototype, {
		...
		uB: function() {
			if (this.C)
				for (var a = this.C.tx(), b = 0; b < a.length; b++)(a[b] instanceof T || a[b] instanceof tc) && a[b].point && this.wa.push(a[b])
		},
		sF: ba("C"),
		St: function(a) {
			this.Mf = a || "none"
	...
	var Yd = bc.prototype;
	S(Yd, {
		getPanoramaById: Yd.Zo,
		getPanoramaByLocation: Yd.pj,
		getPanoramaByPOIId: Yd.ux
	});
	...
	Me.prototype = {
		...
		$u: function(a) {
			if (!(Ae && 0 !== a.touches.length)) {
				...
				if (b.Wk) d = b.scale * b.op, d = Math.max(b.options.Vk, d), d = Math.min(b.options.Wp, d), b.op = d / b.scale, b.scale = d, b.x = b.dy - b.dy * b.op + b.x, b.y = b.ey - b.ey * b.op + b.y, b.Ob.style[oe] = "200ms", b.Ob.style[le] = "translate(" + b.x + "px," + b.y + "px) scale(" + b.scale + ")" + Le, b.Wk = q, b.refresh(), b.options.up && b.options.up.call(b, a);
				else {
					if (b.qh) {
						...
						if (Ae)
							if (b.EK && b.options.zoom) clearTimeout(b.EK), b.EK = p, b.options.vp && b.options.vp.call(b, a), b.zoom(b.uh, b.vh, 1 == b.scale ? b.options.kW : 1), b.options.up && setTimeout(function() {
	...
	S(kf, {
		addCopyright: kf.nw,
		removeCopyright: kf.aF,
		getCopyright: kf.nm,
		getCopyrightCollection: kf.ED
	});
	S(window, {
	...
	S(lf, {
		getMapType: lf.pa,
		getCopyright: lf.nm,
		isTransparentPng: lf.mt
	});
	var mf = cc.prototype;
	S(mf, {
		addItem: mf.qw,
		addSeparator: mf.QB,
		removeSeparator: mf.cF
	});
	var pf = fc.prototype;
	S(pf, {
		setText: pf.Ut
